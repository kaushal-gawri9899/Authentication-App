...
class ChangeNameHandler(BaseHandler):
  ...
  def post(self):
    username = self.request.get('new_username')
...
class SetUserNameHandler(BaseHandler):
  ...
  def post(self):    
    ...
    self._serve_page(new_username, True)

  def _serve_page(self, name, failed=False):
...
app = webapp2.WSGIApplication([
    ...
    webapp2.Route('/name', ChangeNameHandler, name='name'),
